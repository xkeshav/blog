...
export const workList = [
  {
    ...
    description: "A VS Code extension which collect all colors from a css file and assign all colors in intuitive variable name.",
  ...
  },
  {
    ...
    description: "A GitHub Community health files and template for issue and Pull Request generator for any git repo",
    link: "https://npmjs.com/@xkeshav/gh-repo-care",
    tag: "github, health-file, javascript, package, npm",
    date: "Oct 2024",
  },
];
