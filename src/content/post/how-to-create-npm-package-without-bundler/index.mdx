...
here important properties are *files* , *name* and *main*
  ...
  a. *files* will contain files, which will be downloaded when someone do `npm install your package`
  b. *name* is the name of package which is used to indicate when someone do npm install, in my case here it will be `npm install @xkeshav/day`
  c. we are using typescript so *main* and *types* will be there and there file location will be from *lib* folder
