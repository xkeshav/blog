...
3. write domain name with without `www` ; click on *Add domain* ; it will display to add DNS TXT record details
...
8. Add CNAME
    ...
    B. Host Name: add `subdomain`
    C. Value: write `<github-user-name>.github.io`
    D. click on ✅ to save

    Note: all old records ( the default one ) will be automatically removed.
    ![dns-filled-form](./dns-entry-namecheapwe.webp)
