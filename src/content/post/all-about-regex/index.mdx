...
const outout = Array.from(matches);
```
...
Task:  works fine when we have version upto 2 dots  but for chrome we have `126.0.0.0` and we want to capture complete; what could be the proper regex?
